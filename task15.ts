...
type NewObjectType<T, K extends string, V> = T & {[key in K]: V};

export class ObjectManipulator<T> {

    constructor(protected obj: T) {}

    public set<K extends string, V>(key: K, value: V): ObjectManipulator<NewObjectType<T, K, V>>{
        return new ObjectManipulator({...this.obj,[key]: value} as NewObjectType<T, K, V>);
    }
